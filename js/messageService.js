...
this.getMessages = function() {
  return $http.get('https://practiceapi.devmountain.com/api/chats').then(res => res.data).catch(err => console.log(err));
}
  ...
  this.postMessage = function(message) {
    ...
    return $http.post('https://practiceapi.devmountain.com/api/chats', {message: message}).then(res => res.data).catch(err => console.log(err));
  }
